...
Vue.component('message-form', {
    ...
    methods: {
        save: function () {
            ...
            if (this.id) {
                messageApi.update({ id: this.id }, message).then(response =>
                ...
                messageApi.save({}, message).then(response =>
                    response.json().then(data => {
...
const app = new Vue({
    ...
    template:
    '<div>' +
        '<div v-if="!profile">Please, authorize with <a href="/login">Google</a>.</div>' +
        '<div v-else>' +
